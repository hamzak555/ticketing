...
export function EventMap({ location, latitude, longitude, eventTitle }: EventMapProps) {
  ...
  useEffect(() => {
    ...
    setMapInstance(map)
  }, [isLoaded, latitude, longitude, eventTitle, mapInstance])
  ...
  return (
    <div className="space-y-3">
      ...
      <div
        ref={mapRef}
        className="w-full h-[200px] rounded-lg border bg-muted overflow-hidden"
      >
        {!isLoaded && (
